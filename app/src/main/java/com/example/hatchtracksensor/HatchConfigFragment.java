...
public class HatchConfigFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        PeepUnit peepUnit = peepUnitManager.getPeepUnit(0);
